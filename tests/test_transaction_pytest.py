...
def test_form_validate(db_one_user):
    ...
    assert transaction1_form.validate_date(transaction1_form.date) == False
    assert transaction1_form.validate() == False
    #transaction2_form = TransactionForm(title="Bill2", date=date(2021, 3, 1), amount=200.00)
    #assert transaction2_form.validate_date(transaction1_form.date) == True
    ...
    assert transaction3_form.validate_until(transaction1_form.until) == True
    assert transaction3_form.validate_date(transaction1_form.date) == True
    ...
    assert transaction4_form.validate_until(transaction1_form.until) == False
    assert transaction4_form.validate_date(transaction1_form.date) == True
    ...
    assert transaction5_form.validate_until(transaction1_form.until) == False
    assert transaction5_form.validate_date(transaction1_form.date) == True
    ...
    assert transaction6_form.validate_until(transaction1_form.until) == True
    assert transaction6_form.validate_date(transaction1_form.date) == True
